...
public class KyanosGraphQueryInvisibleMethodDeclarations {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryInvisibleMethodDeclarations.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
