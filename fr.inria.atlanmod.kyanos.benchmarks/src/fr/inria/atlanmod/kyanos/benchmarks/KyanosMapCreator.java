...
public class KyanosMapCreator {
	...
	public static void main(String[] args) {
		...
		try {
			...
			URI targetUri = KyanosURI.createKyanosMapURI(new File(commandLine.getOptionValue(OUT)));
			...
			if (targetResource instanceof KyanosMapResourceImpl) {
				KyanosMapResourceImpl.shutdownWithoutUnload((KyanosMapResourceImpl) targetResource); 
			} else {
