...
public class MappingReltypesClass
{
  ...
  protected final String TEXT_5 = NL + NL + "/**" + NL + " * <!-- begin-user-doc -->" + NL + " * Neo4j <b>relationships mapping</b> for model persistence." + NL + " * It provides hashmaps to map relationships to the appropriate feature ID." + NL + " * <!-- end-user-doc -->" + NL + " * @generated" + NL + " */" + NL + "public class ReltypesMappings {";
  ...
  protected final String TEXT_10 = NL + "\tprivate static ReltypesMappings instance;" + NL + "\t" + NL + "\t" + NL + "\t/**" + NL + "\t * " + NL + "\t * @generated" + NL + "\t */" + NL + "\t " + NL + "\tpublic static ReltypesMappings getInstance(){" + NL + "\t\tif (instance == null)" + NL + "\t\t\treturn new ReltypesMappings ();" + NL + "\t\telse return instance;" + NL + "\t\t}" + NL + "\t\t" + NL + "\t/**" + NL + "\t *getter of the Map" + NL + "\t * @generated" + NL + "\t */" + NL + "\t\tpublic Map<String,Map<Point,RelationshipType>> getMap(){" + NL + "\t\treturn reference2relation;" + NL + "\t}" + NL + "\t" + NL + "\t/**" + NL + "\t * constructor of Relationship type mappings" + NL + "\t * @generated" + NL + "\t */" + NL + "\t\tprivate final Map<String,Map<Point,RelationshipType>> reference2relation;" + NL + "\t" + NL + "\t\tprivate ReltypesMappings (){" + NL + "\t\t\t" + NL + "\t\t\treference2relation= new HashMap<String,Map<Point,RelationshipType>>();\t\t";
  protected final String TEXT_11 = NL + "\t\t" + NL + "\t\t\t" + NL + "\t\t";
  protected final String TEXT_12 = NL + "\t\t\t\t\tMap<Point,RelationshipType> map";
  protected final String TEXT_13 = " = new HashMap<Point,RelationshipType>();" + NL + "\t\t\t\t";
  protected final String TEXT_14 = NL + "\t\t\tmap";
  protected final String TEXT_15 = ".put(new Point(";
  protected final String TEXT_16 = ".";
  protected final String TEXT_17 = ",";
  protected final String TEXT_18 = ".";
  protected final String TEXT_19 = "),Reltypes.";
  protected final String TEXT_20 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_21 = NL + "\t\t\treference2relation.put(";
  protected final String TEXT_22 = ".eNS_URI,map";
  protected final String TEXT_23 = ");" + NL + "\t\t";
  protected final String TEXT_24 = NL + "\t\t}" + NL + "\t\t" + NL + "\t/**" + NL + "\t* Getting a Relationship from an eRef belonging to " + NL + "\t* an {@link EObject} eObject" + NL + "\t*@param eObject {@link EObject}" + NL + "\t*@param eRef {@link EReference}" + NL + "\t*@generated" + NL + "\t*/" + NL + "\t//public RelationshipType getReltype(EObject eObject, EReference eRef) {" + NL + "\t\t//\tString key = eObject.eClass().getEPackage().getNsURI();\t\t" + NL + "\t\t\t//return getMap().get(key).get(new Point(eObject.eClass().getClassifierID(), eRef.getFeatureID()));" + NL + "\t\t//}" + NL + "} " + NL + "\t" + NL + "//Reltypes Class";
