 ...
 * </p>
 *
 * @see org.eclipse.gmt.modisco.java.neoemf.meta.JavaPackage#getManifestEntry()
 * @model
...
public interface ManifestEntry extends PersistentEObject {
     ...
     * @see #setName(String)
     * @see org.eclipse.gmt.modisco.java.neoemf.meta.JavaPackage#getManifestEntry_Name()
     ...
     * @see org.eclipse.gmt.modisco.java.neoemf.meta.JavaPackage#getManifestEntry_Attributes()
