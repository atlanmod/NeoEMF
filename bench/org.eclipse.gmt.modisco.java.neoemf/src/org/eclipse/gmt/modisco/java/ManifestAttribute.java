...
public interface ManifestAttribute extends PersistentEObject {
     ...
     * @see #setKey(String)
     * @see org.eclipse.gmt.modisco.java.neoemf.meta.JavaPackage#getManifestAttribute_Key()
     ...
     * @see #setValue(String)
     * @see org.eclipse.gmt.modisco.java.neoemf.meta.JavaPackage#getManifestAttribute_Value()
     * @model unique="false" required="true" ordered="false"
     * @generated
     */
    String getValue();
