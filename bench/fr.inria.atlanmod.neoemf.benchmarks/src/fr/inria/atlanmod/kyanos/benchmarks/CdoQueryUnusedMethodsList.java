...
public class CdoQueryUnusedMethodsList {

	private static final Logger LOG = Logger.getLogger(CdoQueryUnusedMethodsList.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = CdoQueryUnusedMethodsList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
