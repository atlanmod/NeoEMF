...
public class NeoEMFMapQueryThrownExceptions {
	private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryThrownExceptions.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = NeoEMFMapQueryThrownExceptions.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
