...
public class KyanosMapQueryUnusedMethodsList {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryUnusedMethodsList.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryUnusedMethodsList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
