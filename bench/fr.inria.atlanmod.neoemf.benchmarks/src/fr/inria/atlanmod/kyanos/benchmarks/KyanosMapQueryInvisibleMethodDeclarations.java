...
public class KyanosMapQueryInvisibleMethodDeclarations {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryInvisibleMethodDeclarations.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
