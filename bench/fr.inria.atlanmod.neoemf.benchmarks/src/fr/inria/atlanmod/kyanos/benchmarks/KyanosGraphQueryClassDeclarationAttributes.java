...
public class KyanosGraphQueryClassDeclarationAttributes {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryClassDeclarationAttributes.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryClassDeclarationAttributes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
