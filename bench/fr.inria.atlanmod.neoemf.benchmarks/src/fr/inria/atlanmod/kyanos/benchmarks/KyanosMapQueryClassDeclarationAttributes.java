...
public class KyanosMapQueryClassDeclarationAttributes {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryClassDeclarationAttributes.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryClassDeclarationAttributes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
