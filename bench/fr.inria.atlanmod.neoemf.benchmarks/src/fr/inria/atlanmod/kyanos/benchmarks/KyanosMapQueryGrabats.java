...
public class KyanosMapQueryGrabats {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryGrabats.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryGrabats.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
