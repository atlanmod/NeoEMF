...
public class CdoQuerySpecificInvisibleMethodDeclarations {

	private static final Logger LOG = Logger.getLogger(CdoQuerySpecificInvisibleMethodDeclarations.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = CdoQuerySpecificInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
