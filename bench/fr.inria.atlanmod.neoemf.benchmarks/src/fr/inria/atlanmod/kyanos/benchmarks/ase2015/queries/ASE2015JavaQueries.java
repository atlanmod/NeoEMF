 ...
 *******************************************************************************/
package fr.inria.atlanmod.kyanos.benchmarks.ase2015.queries;
...
public class ASE2015JavaQueries {
	...
	public static EList<MethodDeclaration> getSpecificInvisibleMethodDeclarations(Resource resource) {
		...
		if(model.getName().equals("org.eclipse.gmt.modisco.java.kyanos") ||
				model.getName().equals("org.eclipse.jdt.core")) {
			try {
	...
	public static Set<TextElement> getCommentsTagContent(Resource resource) {
		try {
		Set<TextElement> result = new HashSet<TextElement>();
		Model model = (Model)resource.getContents().get(0);
		if(model.getName().equals("org.eclipse.gmt.modisco.java.kyanos") ||
				model.getName().equals("org.eclipse.jdt.core")) {
