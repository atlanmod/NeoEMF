...
public class KyanosGraphQueryThrownExceptionsPerPackage {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryThrownExceptionsPerPackage.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryThrownExceptionsPerPackage.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
