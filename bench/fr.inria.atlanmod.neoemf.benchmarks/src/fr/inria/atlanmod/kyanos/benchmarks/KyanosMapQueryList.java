...
public class KyanosMapQueryList {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryList.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
