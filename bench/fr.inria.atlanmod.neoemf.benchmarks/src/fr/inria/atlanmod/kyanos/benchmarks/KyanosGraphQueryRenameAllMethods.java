...
public class KyanosGraphQueryRenameAllMethods {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryRenameAllMethods.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryRenameAllMethods.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
