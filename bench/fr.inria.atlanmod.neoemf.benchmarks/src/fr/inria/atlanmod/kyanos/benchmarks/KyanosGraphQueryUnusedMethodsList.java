...
public class KyanosGraphQueryUnusedMethodsList {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryUnusedMethodsList.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryUnusedMethodsList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
