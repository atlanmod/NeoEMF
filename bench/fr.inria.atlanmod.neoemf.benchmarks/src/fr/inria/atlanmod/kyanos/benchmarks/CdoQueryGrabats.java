...
public class CdoQueryGrabats {

	private static final Logger LOG = Logger.getLogger(CdoQueryGrabats.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = CdoQueryGrabats.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
