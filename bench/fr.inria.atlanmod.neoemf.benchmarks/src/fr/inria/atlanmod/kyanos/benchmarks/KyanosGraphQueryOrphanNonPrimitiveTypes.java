...
public class KyanosGraphQueryOrphanNonPrimitiveTypes {

	private static final Logger LOG = Logger.getLogger(KyanosGraphQueryOrphanNonPrimitiveTypes.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosGraphQueryOrphanNonPrimitiveTypes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
