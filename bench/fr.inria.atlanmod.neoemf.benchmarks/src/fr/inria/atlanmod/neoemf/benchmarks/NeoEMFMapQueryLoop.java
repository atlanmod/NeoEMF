...
public class NeoEMFMapQueryLoop {
    ...
    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryLoop.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryLoop.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
