...
public class NeoEMFGraphQueryUnusedMethodsList {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryUnusedMethodsList.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryUnusedMethodsList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
