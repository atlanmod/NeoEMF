...
public class NeoEMFGraphQueryLoop {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryLoop.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryLoop.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
