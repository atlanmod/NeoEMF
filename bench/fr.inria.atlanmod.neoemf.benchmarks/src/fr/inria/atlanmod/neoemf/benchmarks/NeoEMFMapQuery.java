...
public class NeoEMFMapQuery {
    ...
    private static final Logger LOG = Logger.getLogger(NeoEMFMapQuery.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQuery.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
