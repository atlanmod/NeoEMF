...
public class NeoEMFGraphQueryClassDeclarationAttributes {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryClassDeclarationAttributes.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryClassDeclarationAttributes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
            ...
            resource.load(loadOpts);
            {
                ...
                LOG.log(Level.INFO, MessageFormat.format("Query result contains {0} elements", list.entrySet().size()));
