...
public class CdoQueryOrphanNonPrimitiveTypes {

    private static final Logger LOG = Logger.getLogger(CdoQueryOrphanNonPrimitiveTypes.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = CdoQueryOrphanNonPrimitiveTypes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
