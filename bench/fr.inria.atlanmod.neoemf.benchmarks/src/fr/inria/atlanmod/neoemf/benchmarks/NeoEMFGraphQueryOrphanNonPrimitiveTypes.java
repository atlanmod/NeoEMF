...
public class NeoEMFGraphQueryOrphanNonPrimitiveTypes {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryOrphanNonPrimitiveTypes.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryOrphanNonPrimitiveTypes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
