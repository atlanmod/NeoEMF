...
public class NeoEMFGraphQuerySpecificInvisibleMethodDeclarations {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQuerySpecificInvisibleMethodDeclarations.class.getName());
