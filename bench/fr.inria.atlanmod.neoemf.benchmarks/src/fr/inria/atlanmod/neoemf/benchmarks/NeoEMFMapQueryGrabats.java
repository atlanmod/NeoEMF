...
public class NeoEMFMapQueryGrabats {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryGrabats.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryGrabats.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
