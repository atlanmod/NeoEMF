...
public class NeoEMFGraphQuery {
    ...
    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQuery.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQuery.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
