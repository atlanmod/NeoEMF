...
public class NeoEMFMapQueryClassDeclarationAttributes {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryClassDeclarationAttributes.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryClassDeclarationAttributes.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
