...
public class KyanosMapQueryLoop {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryLoop.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryLoop.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
