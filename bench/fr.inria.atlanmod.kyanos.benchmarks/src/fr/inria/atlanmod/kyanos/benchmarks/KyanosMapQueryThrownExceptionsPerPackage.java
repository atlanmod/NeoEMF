...
public class KyanosMapQueryThrownExceptionsPerPackage {

	private static final Logger LOG = Logger.getLogger(KyanosMapQueryThrownExceptionsPerPackage.class.getName());
	...
	public static void main(String[] args) {
		...
		try {
			...
			Class<?> inClazz = KyanosMapQueryThrownExceptionsPerPackage.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
