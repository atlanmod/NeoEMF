 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.BreakStatementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BreakStatementImpl extends StatementImpl implements BreakStatement {
	...
	public void setLabel(LabeledStatement newLabel) {
		if (newLabel != label) {
			...
			if (label != null)
				msgs = ((InternalEObject)label).eInverseRemove(this, JavaPackage.LABELED_STATEMENT__USAGES_IN_BREAK_STATEMENTS, LabeledStatement.class, msgs);
			if (newLabel != null)
