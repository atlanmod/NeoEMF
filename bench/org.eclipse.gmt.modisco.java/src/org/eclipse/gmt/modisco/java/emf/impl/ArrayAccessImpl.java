 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.ArrayAccessImpl#getArray <em>Array</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.ArrayAccessImpl#getIndex <em>Index</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayAccessImpl extends ExpressionImpl implements ArrayAccess {
    ...
    public void setArray(Expression newArray) {
        if (newArray != array) {
            ...
            if (array != null)
                msgs = ((InternalEObject)array).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_ACCESS__ARRAY, null, msgs);
            if (newArray != null)
    ...
    public void setIndex(Expression newIndex) {
        if (newIndex != index) {
            NotificationChain msgs = null;
            if (index != null)
                msgs = ((InternalEObject)index).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_ACCESS__INDEX, null, msgs);
            if (newIndex != null)
