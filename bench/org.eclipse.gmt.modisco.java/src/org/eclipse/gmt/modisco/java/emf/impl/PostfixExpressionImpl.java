 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.PostfixExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.PostfixExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PostfixExpressionImpl extends ExpressionImpl implements PostfixExpression {
    ...
    public void setOperator(PostfixExpressionKind newOperator) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, JavaPackage.POSTFIX_EXPRESSION__OPERATOR, oldOperator, operator));
    }
    ...
    public void setOperand(Expression newOperand) {
        if (newOperand != operand) {
            ...
            if (operand != null)
                msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.POSTFIX_EXPRESSION__OPERAND, null, msgs);
            if (newOperand != null)
