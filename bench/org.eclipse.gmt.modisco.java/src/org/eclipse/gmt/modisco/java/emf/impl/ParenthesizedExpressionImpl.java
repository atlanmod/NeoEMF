 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.ParenthesizedExpressionImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParenthesizedExpressionImpl extends ExpressionImpl implements ParenthesizedExpression {
	...
	public void setExpression(Expression newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.PARENTHESIZED_EXPRESSION__EXPRESSION, null, msgs);
