 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.CatchClauseImpl#getException <em>Exception</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.CatchClauseImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CatchClauseImpl extends StatementImpl implements CatchClause {
    ...
    public void setException(SingleVariableDeclaration newException) {
        if (newException != exception) {
            ...
            if (exception != null)
                msgs = ((InternalEObject)exception).eInverseRemove(this, JavaPackage.SINGLE_VARIABLE_DECLARATION__CATCH_CLAUSE, SingleVariableDeclaration.class, msgs);
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case JavaPackage.CATCH_CLAUSE__EXCEPTION:
                if (exception != null)
                    msgs = ((InternalEObject)exception).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.CATCH_CLAUSE__EXCEPTION, null, msgs);
