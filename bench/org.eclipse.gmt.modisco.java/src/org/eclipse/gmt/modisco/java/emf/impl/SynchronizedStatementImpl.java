 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.SynchronizedStatementImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.SynchronizedStatementImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SynchronizedStatementImpl extends StatementImpl implements SynchronizedStatement {
    ...
    public void setBody(Block newBody) {
        if (newBody != body) {
            ...
            if (body != null)
                msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SYNCHRONIZED_STATEMENT__BODY, null, msgs);
            if (newBody != null)
    ...
    public void setExpression(Expression newExpression) {
        if (newExpression != expression) {
            NotificationChain msgs = null;
            if (expression != null)
                msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SYNCHRONIZED_STATEMENT__EXPRESSION, null, msgs);
