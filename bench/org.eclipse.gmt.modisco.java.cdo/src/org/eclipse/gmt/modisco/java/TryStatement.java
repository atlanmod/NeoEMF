...
public interface TryStatement extends Statement {
     ...
     * @see #setBody(Block)
     * @see org.eclipse.gmt.modisco.java.cdo.meta.JavaPackage#getTryStatement_Body()
     ...
     * @see org.eclipse.gmt.modisco.java.cdo.meta.JavaPackage#getTryStatement_Finally()
     ...
     * @see org.eclipse.gmt.modisco.java.cdo.meta.JavaPackage#getTryStatement_CatchClauses()
