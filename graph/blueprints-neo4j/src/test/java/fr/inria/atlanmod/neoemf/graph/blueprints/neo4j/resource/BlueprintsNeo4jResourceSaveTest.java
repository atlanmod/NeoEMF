...
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.ARRAYS_MAPPED_MEMORY;
...
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.NODES_MAPPED_MEMORY;
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.PROPERTIES_MAPPED_MEMORY;
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.RELATIONSHIPS_MAPPED_MEMORY;
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.STRINGS_MAPPED_MEMORY;
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.USE_MEMORY_MAPPED_BUFFERS;
import static fr.inria.atlanmod.neoemf.graph.blueprints.neo4j.resource.BlueprintsNeo4jResourceOptions.UseMemoryMappedBuffer;
...
public class BlueprintsNeo4jResourceSaveTest extends BlueprintsResourceSaveTest {
    ...
    public void testSaveGraphNeo4jResourceNeo4jTypeOption() throws IOException, ConfigurationException {
        ...
        assertConfigurationHasEntry(configuration, GRAPH_TYPE, GRAPH_TYPE_NEO4J);
        /*
    ...
    public void testSaveGraphNeo4jResourceNoneCacheTypeOption() throws IOException, ConfigurationException {
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, CACHE_TYPE, CacheType.NONE.toString());
    ...
    public void testSaveGraphNeo4jResourceWeakCacheTypeOption() throws IOException, ConfigurationException {
        options.put(CACHE_TYPE, CacheType.WEAK);
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, CACHE_TYPE, CacheType.WEAK.toString());
    ...
    public void testSaveGraphNeo4jResourceSoftCacheTypeOption() throws IOException, ConfigurationException {
        options.put(CACHE_TYPE, CacheType.SOFT);
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, CACHE_TYPE, CacheType.SOFT.toString());
    ...
    public void testSaveGraphNeo4jResourceStrongCacheTypeOption() throws IOException, ConfigurationException {
        options.put(CACHE_TYPE, CacheType.STRONG);
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, CACHE_TYPE, CacheType.STRONG.toString());
    ...
    public void testSaveGraphNeo4jResourceTrueUseMemoryMappedBuffersOption() throws IOException, ConfigurationException {
        options.put(USE_MEMORY_MAPPED_BUFFERS, UseMemoryMappedBuffer.TRUE);
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, USE_MEMORY_MAPPED_BUFFERS, UseMemoryMappedBuffer.TRUE.toString());
    ...
    public void testSaveGraphNeo4jResourceTrueBooleanUseMemoryMappedBuffersOption() throws IOException, ConfigurationException {
        options.put(USE_MEMORY_MAPPED_BUFFERS, true);
        resource.save(options);
    ...
    public void testSaveGraphNeo4jResourceFalseUseMemoryMappedBuffersOption() throws IOException, ConfigurationException {
        options.put(USE_MEMORY_MAPPED_BUFFERS, UseMemoryMappedBuffer.FALSE);
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, USE_MEMORY_MAPPED_BUFFERS, UseMemoryMappedBuffer.FALSE.toString());
    ...
    public void testSaveGraphNeo4jResourceFalseBooleanUseMemoryMappedBuffersOption() throws IOException, ConfigurationException {
        options.put(USE_MEMORY_MAPPED_BUFFERS, false);
        resource.save(options);
    ...
    public void testSaveGraphNeo4jResourcePositiveStringsMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(STRINGS_MAPPED_MEMORY, "64M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, STRINGS_MAPPED_MEMORY, "64M");
    ...
    public void testSaveGraphNeo4jResourceNullStringsMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(STRINGS_MAPPED_MEMORY, "0M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, STRINGS_MAPPED_MEMORY, "0M");
    ...
    public void testSaveGraphNeo4jResourcePositiveArraysMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(ARRAYS_MAPPED_MEMORY, "64M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, ARRAYS_MAPPED_MEMORY, "64M");
    ...
    public void testSaveGraphNeo4jResourceNullArraysMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(ARRAYS_MAPPED_MEMORY, "0M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, ARRAYS_MAPPED_MEMORY, "0M");
    ...
    public void testSaveGraphNeo4jResourcePositiveNodesMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(NODES_MAPPED_MEMORY, "64M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, NODES_MAPPED_MEMORY, "64M");
    ...
    public void testSaveGraphNeo4jResourceNegativeNodesMappedMemoryOption() throws IOException {
        options.put(NODES_MAPPED_MEMORY, "-64");
        resource.save(options);
    }
    ...
    public void testSaveGraphNeo4jResourceNullNodesMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(NODES_MAPPED_MEMORY, "0M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, NODES_MAPPED_MEMORY, "0M");
    ...
    public void testSaveGraphNeo4jResourcePositivePropertiesMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(PROPERTIES_MAPPED_MEMORY, "64M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, PROPERTIES_MAPPED_MEMORY, "64M");
    ...
    public void testSaveGraphNeo4jResourceNullPropertiesMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(PROPERTIES_MAPPED_MEMORY, "0M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, PROPERTIES_MAPPED_MEMORY, "0M");
    ...
    public void testSaveGraphNeo4jResourcePositiveRelationshipsMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(RELATIONSHIPS_MAPPED_MEMORY, "64M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, RELATIONSHIPS_MAPPED_MEMORY, "64M");
    ...
    public void testSaveGraphNeo4jResourceNullRelationshipsMappedMemoryOption() throws IOException, ConfigurationException {
        options.put(RELATIONSHIPS_MAPPED_MEMORY, "0M");
        resource.save(options);
        ...
        PropertiesConfiguration configuration = new PropertiesConfiguration(configFile);
        assertConfigurationHasEntry(configuration, RELATIONSHIPS_MAPPED_MEMORY, "0M");
