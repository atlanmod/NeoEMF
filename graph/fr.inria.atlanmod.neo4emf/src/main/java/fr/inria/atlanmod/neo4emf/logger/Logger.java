package fr.inria.atlanmod.neo4emf.logger;
...
public class Logger {
    ...
    static {
        log = Neo4emfPlugin.getDefault().getLog();    
    }
    
    public static void log(int severity, Throwable e) {
        log.log(new Status(severity, Neo4emfPlugin.PLUGIN_ID,
        		e.getMessage() != null ? e.getMessage() : e.toString(), e));
    }

    public static void log(int severity, String msg, Throwable e) {
    	log.log(new Status(severity, Neo4emfPlugin.PLUGIN_ID, msg, e));
    }
    
    public static void log(int severity, String msg) {
        log.log(new Status(severity, Neo4emfPlugin.PLUGIN_ID, msg, null));
    }
