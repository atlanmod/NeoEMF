...
public class CdoQueryList extends CdoQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = CdoQueryList.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
            ...
            try (EmbeddedCDOServer server = new EmbeddedCDOServer(repositoryDir, repositoryName)) {
                ...
                Queries.getUnusedMethodsList(resource).callWithTimeSpent(); // Query result (lists)
