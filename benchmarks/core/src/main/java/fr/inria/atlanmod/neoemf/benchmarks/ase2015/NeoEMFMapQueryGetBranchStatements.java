...
public class NeoEMFMapQueryGetBranchStatements extends NeoEMFMapQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryGetBranchStatements.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
