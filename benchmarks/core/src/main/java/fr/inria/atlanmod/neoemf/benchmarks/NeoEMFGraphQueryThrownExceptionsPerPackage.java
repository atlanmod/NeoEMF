...
public class NeoEMFGraphQueryThrownExceptionsPerPackage {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryThrownExceptionsPerPackage.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryThrownExceptionsPerPackage.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
