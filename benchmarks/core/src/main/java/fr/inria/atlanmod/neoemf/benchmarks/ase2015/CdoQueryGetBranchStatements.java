...
public class CdoQueryGetBranchStatements {
    ...
    private static final Logger LOG = Logger.getLogger(CdoQueryGetBranchStatements.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = CdoQueryGetBranchStatements.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
