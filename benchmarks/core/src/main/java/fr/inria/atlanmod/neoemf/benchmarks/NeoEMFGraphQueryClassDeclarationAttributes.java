...
public class NeoEMFGraphQueryClassDeclarationAttributes {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryClassDeclarationAttributes.class.getClassLoader().loadClass(cli.get(CommandLineUtil.Key.EPACKAGE_CLASS));
            ...
            resource.load(loadOpts);
            {
                ...
                LOG.info("End query");
                LOG.info("Query result contains {0} elements", list.entrySet().size());
