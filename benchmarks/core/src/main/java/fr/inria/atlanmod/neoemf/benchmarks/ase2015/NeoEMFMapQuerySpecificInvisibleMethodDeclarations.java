...
public class NeoEMFMapQuerySpecificInvisibleMethodDeclarations {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQuerySpecificInvisibleMethodDeclarations.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQuerySpecificInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
