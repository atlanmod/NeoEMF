...
public class NeoEMFGraphQueryUnusedMethodsList extends NeoEMFGraphQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryUnusedMethodsList.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
