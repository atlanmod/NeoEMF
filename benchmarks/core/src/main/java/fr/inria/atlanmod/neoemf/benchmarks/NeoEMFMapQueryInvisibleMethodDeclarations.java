...
public class NeoEMFMapQueryInvisibleMethodDeclarations {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryInvisibleMethodDeclarations.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
