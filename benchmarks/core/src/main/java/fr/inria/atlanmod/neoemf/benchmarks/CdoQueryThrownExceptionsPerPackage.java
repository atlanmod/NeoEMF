...
public class CdoQueryThrownExceptionsPerPackage {
    ...
    private static final Logger LOG = Logger.getLogger(CdoQueryThrownExceptionsPerPackage.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = CdoQueryThrownExceptionsPerPackage.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
