...
public class NeoEMFMapQueryUnusedMethodsList {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryUnusedMethodsList.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryUnusedMethodsList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
