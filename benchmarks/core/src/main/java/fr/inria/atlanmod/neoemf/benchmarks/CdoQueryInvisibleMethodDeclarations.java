...
public class CdoQueryInvisibleMethodDeclarations {

    private static final Logger LOG = Logger.getLogger(CdoQueryInvisibleMethodDeclarations.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = CdoQueryInvisibleMethodDeclarations.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
