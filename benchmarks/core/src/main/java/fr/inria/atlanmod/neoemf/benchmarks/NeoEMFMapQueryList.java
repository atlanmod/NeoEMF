...
public class NeoEMFMapQueryList {

    private static final Logger LOG = Logger.getLogger(NeoEMFMapQueryList.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryList.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
