...
public class NeoEMFMapQueryThrownExceptionsPerPackage extends NeoEMFMapQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryThrownExceptionsPerPackage.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
