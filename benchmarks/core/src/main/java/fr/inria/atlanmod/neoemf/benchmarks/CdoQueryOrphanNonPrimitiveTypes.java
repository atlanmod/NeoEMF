...
public class CdoQueryOrphanNonPrimitiveTypes extends CdoQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = CdoQueryOrphanNonPrimitiveTypes.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
