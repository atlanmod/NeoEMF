...
public class NeoEMFMapQueryThrownExceptions extends NeoEMFMapQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFMapQueryThrownExceptions.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
