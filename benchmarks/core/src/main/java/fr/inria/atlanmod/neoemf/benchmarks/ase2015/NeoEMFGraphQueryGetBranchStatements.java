...
public class NeoEMFGraphQueryGetBranchStatements extends NeoEMFGraphQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryGetBranchStatements.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
