...
public class NeoEMFGraphQueryThrownExceptions {

    private static final Logger LOG = Logger.getLogger(NeoEMFGraphQueryThrownExceptions.class.getName());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryThrownExceptions.class.getClassLoader().loadClass(commandLine.getOptionValue(EPACKAGE_CLASS));
