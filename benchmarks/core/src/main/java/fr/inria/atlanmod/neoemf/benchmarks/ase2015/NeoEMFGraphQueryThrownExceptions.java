...
public class NeoEMFGraphQueryThrownExceptions extends NeoEMFGraphQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryThrownExceptions.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
