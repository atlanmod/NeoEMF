...
public class NeoEMFGraphQueryOrphanNonPrimitiveTypes extends NeoEMFGraphQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryOrphanNonPrimitiveTypes.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
