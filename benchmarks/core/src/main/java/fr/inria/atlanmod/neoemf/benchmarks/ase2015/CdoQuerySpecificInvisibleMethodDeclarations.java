...
public class CdoQuerySpecificInvisibleMethodDeclarations extends CdoQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = CdoQuerySpecificInvisibleMethodDeclarations.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
