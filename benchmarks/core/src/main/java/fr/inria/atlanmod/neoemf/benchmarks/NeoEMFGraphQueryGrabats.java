...
public class NeoEMFGraphQueryGrabats extends NeoEMFGraphQuery {
    ...
    public static void main(String[] args) {
        try {
            ...
            Class<?> inClazz = NeoEMFGraphQueryGrabats.class.getClassLoader().loadClass(cli.get(EPACKAGE_CLASS));
