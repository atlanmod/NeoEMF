...
public class ContainmentTest extends AbstractBackendTest {
    ...
    public void testAddContainmentSubtree() {
        ...
        assertThat(p1.eStore()).isInstanceOf(Store.class);
        assertThat(p2.eStore()).isInstanceOf(Store.class);
        assertThat(p3.eStore()).isInstanceOf(Store.class);
        assertThat(pc1.eStore()).isInstanceOf(Store.class);
    ...
    public void testSetContainmentAfterNonContainment() {
        ...
        assertThat(com1.eStore()).isInstanceOf(Store.class);
