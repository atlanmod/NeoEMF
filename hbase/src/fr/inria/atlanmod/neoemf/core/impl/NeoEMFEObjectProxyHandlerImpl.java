...
import fr.inria.atlanmod.neoemf.datastore.estores.impl.NullEStoreImpl;

public class NeoEMFEObjectProxyHandlerImpl extends MinimalEStoreEObjectImpl implements MethodInterceptor, NeoEMFInternalEObject {
	...
	public NeoEMFEObjectProxyHandlerImpl(InternalEObject internalEObject) {
		super();
	...
	public void neoemfSetResource(Internal resource) {
		if (resource instanceof NeoEMFResource) {
			NeoEMFResource neoEMFResource = (NeoEMFResource) resource;
			this.neoemfResource = neoEMFResource;
			this.eStore = neoEMFResource.eStore();
