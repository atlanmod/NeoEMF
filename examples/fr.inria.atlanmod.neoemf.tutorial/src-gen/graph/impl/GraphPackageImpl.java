...
public class GraphPackageImpl extends EPackageImpl implements GraphPackage {
	 ...
	 * @generated
	 */
	private EClass verticeEClass = null;
	 ...
	 * @generated
	 */
	public EClass getVertice() {
		return verticeEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getVertice_Label() {
		return (EAttribute)verticeEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		verticeEClass = createEClass(VERTICE);
		createEAttribute(verticeEClass, VERTICE__LABEL);
	...
	public void initializePackageContents() {
		...
		initEReference(getGraph_Vertices(), this.getVertice(), null, "vertices", null, 0, -1, Graph.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(verticeEClass, Vertice.class, "Vertice", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVertice_Label(), ecorePackage.getEString(), "label", null, 0, 1, Vertice.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(edgeEClass, Edge.class, "Edge", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEdge_From(), this.getVertice(), null, "from", null, 0, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getEdge_To(), this.getVertice(), null, "to", null, 0, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
