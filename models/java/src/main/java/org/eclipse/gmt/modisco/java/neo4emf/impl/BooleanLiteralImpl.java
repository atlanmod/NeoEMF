 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.BooleanLiteralImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 ...
 */
	public void setValue(boolean newValue) {
		...
		boolean oldValue = getData().value;
		getData().value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
			this, Notification.SET,
			JavaPackage.BOOLEAN_LITERAL__VALUE,
			oldValue, getData().value));
	    addChangelogEntry(newValue, JavaPackage.BOOLEAN_LITERAL__VALUE);
	} 
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case JavaPackage.BOOLEAN_LITERAL__VALUE:
				setValue(DataBooleanLiteral.VALUE_EDEFAULT);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case JavaPackage.BOOLEAN_LITERAL__VALUE:
				return isValue() != DataBooleanLiteral.VALUE_EDEFAULT;
		}
