 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SwitchStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SwitchStatementImpl#getStatements <em>Statements</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getExpression() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SWITCH_STATEMENT__EXPRESSION);
		}
	...
	public void setExpression(Expression newExpression) {
		...
		if (newExpression != getData().expression) {
			...
			if (getData().expression != null)
				msgs = ((InternalEObject) getData().expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SWITCH_STATEMENT__EXPRESSION, null, msgs);
	    ...
	    addChangelogEntry(newExpression, JavaPackage.SWITCH_STATEMENT__EXPRESSION);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<Statement> getStatements() {
		...
		if (getData().statements == null){
		getData().statements = new EObjectContainmentEList<Statement>(Statement.class, this, JavaPackage.SWITCH_STATEMENT__STATEMENTS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SWITCH_STATEMENT__STATEMENTS);			}
