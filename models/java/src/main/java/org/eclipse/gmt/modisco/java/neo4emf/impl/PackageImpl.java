 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PackageImpl#getOwnedElements <em>Owned Elements</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PackageImpl#getModel <em>Model</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PackageImpl#getOwnedPackages <em>Owned Packages</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PackageImpl#getPackage <em>Package</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PackageImpl#getUsagesInPackageAccess <em>Usages In Package Access</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PackageImpl extends NamedElementImpl implements org.eclipse.gmt.modisco.java.Package {
	 ...
	 */
	 @Override
	protected DataPackage getData(){
		if ( data == null || !(data instanceof DataPackage)){
...
/** genFeaure.override.javajetinc **/
	...
	public EList<AbstractTypeDeclaration> getOwnedElements() {
		...
		getData().ownedElements = new EObjectContainmentWithInverseEList<AbstractTypeDeclaration>(AbstractTypeDeclaration.class, this, JavaPackage.PACKAGE__OWNED_ELEMENTS, JavaPackage.ABSTRACT_TYPE_DECLARATION__PACKAGE);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.PACKAGE__OWNED_ELEMENTS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public Model getModel() {
		...
		if (isLoaded() && eContainer() == null) {
			Model model = (Model) ((INeo4emfResource) this.eResource()).getContainerOnDemand(this, JavaPackage.PACKAGE__MODEL);
 ...
 */
	public void setModel(Model newModel) {
	    ...
	    addChangelogEntry(newModel, JavaPackage.PACKAGE__MODEL);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<org.eclipse.gmt.modisco.java.Package> getOwnedPackages() {
		...
		if (getData().ownedPackages == null){
		getData().ownedPackages = new EObjectContainmentWithInverseEList<org.eclipse.gmt.modisco.java.Package>(org.eclipse.gmt.modisco.java.Package.class, this, JavaPackage.PACKAGE__OWNED_PACKAGES, JavaPackage.PACKAGE__PACKAGE);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.PACKAGE__OWNED_PACKAGES);			}
		return getData().ownedPackages;
	} finally {
	loadingOnDemand = false;
}
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public org.eclipse.gmt.modisco.java.Package getPackage() {
		...
		if (isLoaded() && eContainer() == null) {
			org.eclipse.gmt.modisco.java.Package package_ = (org.eclipse.gmt.modisco.java.Package) ((INeo4emfResource) this.eResource()).getContainerOnDemand(this, JavaPackage.PACKAGE__PACKAGE);
 ...
 */
	public void setPackage(org.eclipse.gmt.modisco.java.Package newPackage) {
	    ...
	    addChangelogEntry(newPackage, JavaPackage.PACKAGE__PACKAGE);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<PackageAccess> getUsagesInPackageAccess() {
		...
		if (getData().usagesInPackageAccess == null){
		getData().usagesInPackageAccess = new EObjectWithInverseResolvingEList<PackageAccess>(PackageAccess.class, this, JavaPackage.PACKAGE__USAGES_IN_PACKAGE_ACCESS, JavaPackage.PACKAGE_ACCESS__PACKAGE);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.PACKAGE__USAGES_IN_PACKAGE_ACCESS);			}
		return getData().usagesInPackageAccess;
	} finally {
	loadingOnDemand = false;
}
	} 
...
/**
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case JavaPackage.PACKAGE__OWNED_PACKAGES:
				return getOwnedPackages() != null && !getOwnedPackages().isEmpty();
			case JavaPackage.PACKAGE__PACKAGE:
				return getPackage() != null;
			case JavaPackage.PACKAGE__USAGES_IN_PACKAGE_ACCESS:
				return getUsagesInPackageAccess() != null && !getUsagesInPackageAccess().isEmpty();
		}
...
protected static  class DataPackage extends DataNamedElement {
...
// The goal of this template is to BLAH, BLAH, BLAH
	 ...
	 * @generated
	 */
	//public DataPackage(DataNamedElement data)
	//{
	//	this();		
	//	
	//	name = data.name;
