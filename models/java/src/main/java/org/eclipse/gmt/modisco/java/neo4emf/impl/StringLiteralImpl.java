 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.StringLiteralImpl#getEscapedValue <em>Escaped Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 ...
 */
	public void setEscapedValue(String newEscapedValue) {
		...
		if (eNotificationRequired())
			...
			JavaPackage.STRING_LITERAL__ESCAPED_VALUE,
			oldEscapedValue, getData().escapedValue));
	    addChangelogEntry(newEscapedValue, JavaPackage.STRING_LITERAL__ESCAPED_VALUE);
	} 
