 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.ContinueStatementImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public LabeledStatement getLabel() {
		...
		if (getData().label == null && isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.CONTINUE_STATEMENT__LABEL);
		}		
	...
	public void setLabel(LabeledStatement newLabel) {
		...
		if (newLabel != getData().label) {
			...
			if (getData().label != null)
				msgs = ((InternalEObject) getData().label).eInverseRemove(this, JavaPackage.LABELED_STATEMENT__USAGES_IN_CONTINUE_STATEMENTS, LabeledStatement.class, msgs);
			if (newLabel != null)
	    ...
	    addChangelogEntry(newLabel, JavaPackage.CONTINUE_STATEMENT__LABEL);
	} 
