 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.InitializerImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public Block getBody() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.INITIALIZER__BODY);
		}
		return getData().body;
	} finally {
	...
	public void setBody(Block newBody) {
		...
		if (newBody != getData().body) {
			...
			if (getData().body != null)
				msgs = ((InternalEObject) getData().body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.INITIALIZER__BODY, null, msgs);
			if (newBody != null)
	    ...
	    addChangelogEntry(newBody, JavaPackage.INITIALIZER__BODY);
	} 
