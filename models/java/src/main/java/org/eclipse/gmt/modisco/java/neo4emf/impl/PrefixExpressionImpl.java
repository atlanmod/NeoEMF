 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PrefixExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.PrefixExpressionImpl#getOperand <em>Operand</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 ...
 */
	public void setOperator(PrefixExpressionKind newOperator) {
		...
		PrefixExpressionKind oldOperator = getData().operator;
		getData().operator = newOperator == null ? getData().OPERATOR_EDEFAULT : newOperator;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
			this, Notification.SET,
			JavaPackage.PREFIX_EXPRESSION__OPERATOR,
			oldOperator, getData().operator));
	    addChangelogEntry(newOperator, JavaPackage.PREFIX_EXPRESSION__OPERATOR);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getOperand() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.PREFIX_EXPRESSION__OPERAND);
		}
	...
	public void setOperand(Expression newOperand) {
		...
		if (newOperand != getData().operand) {
			...
			if (getData().operand != null)
				msgs = ((InternalEObject) getData().operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.PREFIX_EXPRESSION__OPERAND, null, msgs);
			if (newOperand != null)
	    ...
	    addChangelogEntry(newOperand, JavaPackage.PREFIX_EXPRESSION__OPERAND);
	} 
