 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.DoStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.DoStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getExpression() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.DO_STATEMENT__EXPRESSION);
		}
	...
	public void setExpression(Expression newExpression) {
		...
		if (newExpression != getData().expression) {
			...
			if (getData().expression != null)
				msgs = ((InternalEObject) getData().expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.DO_STATEMENT__EXPRESSION, null, msgs);
	    ...
	    addChangelogEntry(newExpression, JavaPackage.DO_STATEMENT__EXPRESSION);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public Statement getBody() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.DO_STATEMENT__BODY);
		}
		return getData().body;
	} finally {
	loadingOnDemand = false;
	...
	public void setBody(Statement newBody) {
		...
		if (newBody != getData().body) {
			...
			if (getData().body != null)
				msgs = ((InternalEObject) getData().body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.DO_STATEMENT__BODY, null, msgs);
			if (newBody != null)
	    ...
	    addChangelogEntry(newBody, JavaPackage.DO_STATEMENT__BODY);
	} 
