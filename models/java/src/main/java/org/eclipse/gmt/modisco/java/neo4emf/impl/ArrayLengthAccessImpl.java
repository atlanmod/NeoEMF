 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.ArrayLengthAccessImpl#getArray <em>Array</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ArrayLengthAccessImpl extends ExpressionImpl implements ArrayLengthAccess {
	 ...
	 */
	 @Override
	protected DataArrayLengthAccess getData(){
		if ( data == null || !(data instanceof DataArrayLengthAccess)){
			data = new DataArrayLengthAccess();
			if (isLoaded())
			((INeo4emfResource) this.eResource()).fetchAttributes(this);
			}
		return (DataArrayLengthAccess) data;
	}
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getArray() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ARRAY_LENGTH_ACCESS__ARRAY);
		}
	...
	public void setArray(Expression newArray) {
		...
		if (newArray != getData().array) {
			...
			if (getData().array != null)
				msgs = ((InternalEObject) getData().array).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ARRAY_LENGTH_ACCESS__ARRAY, null, msgs);
			if (newArray != null)
	    ...
	    addChangelogEntry(newArray, JavaPackage.ARRAY_LENGTH_ACCESS__ARRAY);
	} 
...
protected static  class DataArrayLengthAccess extends DataExpression {
...
// The goal of this template is to BLAH, BLAH, BLAH
	...
	/**
	 *Constructor of DataArrayLengthAccess
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public DataArrayLengthAccess() {
		 super(); 
	}
	 ...
	 * @generated
	 */
	//public DataArrayLengthAccess(DataExpression data)
	//{
	//	this();		
	//	
	//	}
