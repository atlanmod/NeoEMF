 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.EnumConstantDeclarationImpl#getExtraArrayDimensions <em>Extra Array Dimensions</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.EnumConstantDeclarationImpl#getInitializer <em>Initializer</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.EnumConstantDeclarationImpl#getUsageInVariableAccess <em>Usage In Variable Access</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.EnumConstantDeclarationImpl#getAnonymousClassDeclaration <em>Anonymous Class Declaration</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.EnumConstantDeclarationImpl#getArguments <em>Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 ...
 */
	public void setExtraArrayDimensions(int newExtraArrayDimensions) {
		...
		if (eNotificationRequired())
			...
			JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS,
			oldExtraArrayDimensions, getData().extraArrayDimensions));
	    addChangelogEntry(newExtraArrayDimensions, JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getInitializer() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER);
		}
	...
	public void setInitializer(Expression newInitializer) {
		...
		if (newInitializer != getData().initializer) {
			...
			if (getData().initializer != null)
				msgs = ((InternalEObject) getData().initializer).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER, null, msgs);
	    ...
	    addChangelogEntry(newInitializer, JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<SingleVariableAccess> getUsageInVariableAccess() {
		...
		getData().usageInVariableAccess = new EObjectWithInverseResolvingEList<SingleVariableAccess>(SingleVariableAccess.class, this, JavaPackage.ENUM_CONSTANT_DECLARATION__USAGE_IN_VARIABLE_ACCESS, JavaPackage.SINGLE_VARIABLE_ACCESS__VARIABLE);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ENUM_CONSTANT_DECLARATION__USAGE_IN_VARIABLE_ACCESS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public AnonymousClassDeclaration getAnonymousClassDeclaration() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION);
		}
	...
	public void setAnonymousClassDeclaration(AnonymousClassDeclaration newAnonymousClassDeclaration) {
		...
		if (newAnonymousClassDeclaration != getData().anonymousClassDeclaration) {
			...
			if (getData().anonymousClassDeclaration != null)
				msgs = ((InternalEObject) getData().anonymousClassDeclaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION, null, msgs);
	    ...
	    addChangelogEntry(newAnonymousClassDeclaration, JavaPackage.ENUM_CONSTANT_DECLARATION__ANONYMOUS_CLASS_DECLARATION);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<Expression> getArguments() {
		...
		getData().arguments = new EObjectContainmentEList<Expression>(Expression.class, this, JavaPackage.ENUM_CONSTANT_DECLARATION__ARGUMENTS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ENUM_CONSTANT_DECLARATION__ARGUMENTS);			}
...
/**
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS:
				setExtraArrayDimensions(DataEnumConstantDeclaration.EXTRA_ARRAY_DIMENSIONS_EDEFAULT);
				return;
			case JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case JavaPackage.ENUM_CONSTANT_DECLARATION__EXTRA_ARRAY_DIMENSIONS:
				return getExtraArrayDimensions() != DataEnumConstantDeclaration.EXTRA_ARRAY_DIMENSIONS_EDEFAULT;
			case JavaPackage.ENUM_CONSTANT_DECLARATION__INITIALIZER:
