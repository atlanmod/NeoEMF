 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getBody <em>Body</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getThrownExceptions <em>Thrown Exceptions</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getTypeParameters <em>Type Parameters</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getUsagesInDocComments <em>Usages In Doc Comments</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.AbstractMethodDeclarationImpl#getUsages <em>Usages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractMethodDeclarationImpl extends BodyDeclarationImpl implements AbstractMethodDeclaration {
	 ...
	 */
	 @Override
	protected DataAbstractMethodDeclaration getData(){
		if ( data == null || !(data instanceof DataAbstractMethodDeclaration)){
			data = new DataAbstractMethodDeclaration();
			if (isLoaded())
			((INeo4emfResource) this.eResource()).fetchAttributes(this);
			}
		return (DataAbstractMethodDeclaration) data;
	}
...
/** genFeaure.override.javajetinc **/
	...
	public Block getBody() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__BODY);
		}
		return getData().body;
	} finally {
	...
	public void setBody(Block newBody) {
		...
		if (newBody != getData().body) {
			...
			if (getData().body != null)
				msgs = ((InternalEObject) getData().body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.ABSTRACT_METHOD_DECLARATION__BODY, null, msgs);
			if (newBody != null)
	    ...
	    addChangelogEntry(newBody, JavaPackage.ABSTRACT_METHOD_DECLARATION__BODY);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<SingleVariableDeclaration> getParameters() {
		...
		getData().parameters = new EObjectContainmentWithInverseEList<SingleVariableDeclaration>(SingleVariableDeclaration.class, this, JavaPackage.ABSTRACT_METHOD_DECLARATION__PARAMETERS, JavaPackage.SINGLE_VARIABLE_DECLARATION__METHOD_DECLARATION);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__PARAMETERS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public EList<TypeAccess> getThrownExceptions() {
		...
		if (getData().thrownExceptions == null){
		getData().thrownExceptions = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, JavaPackage.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__THROWN_EXCEPTIONS);			}
		return getData().thrownExceptions;
	} finally {
	loadingOnDemand = false;
}
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<TypeParameter> getTypeParameters() {
		...
		getData().typeParameters = new EObjectContainmentEList<TypeParameter>(TypeParameter.class, this, JavaPackage.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__TYPE_PARAMETERS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public EList<MethodRef> getUsagesInDocComments() {
		...
		if (getData().usagesInDocComments == null){
		getData().usagesInDocComments = new EObjectWithInverseResolvingEList<MethodRef>(MethodRef.class, this, JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS, JavaPackage.METHOD_REF__METHOD);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS);			}
		return getData().usagesInDocComments;
	} finally {
	loadingOnDemand = false;
}
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<AbstractMethodInvocation> getUsages() {
		...
		getData().usages = new EObjectWithInverseResolvingEList<AbstractMethodInvocation>(AbstractMethodInvocation.class, this, JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES, JavaPackage.ABSTRACT_METHOD_INVOCATION__METHOD);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES);			}
...
/**
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES_IN_DOC_COMMENTS:
				return getUsagesInDocComments() != null && !getUsagesInDocComments().isEmpty();
			case JavaPackage.ABSTRACT_METHOD_DECLARATION__USAGES:
...
protected static  class DataAbstractMethodDeclaration extends DataBodyDeclaration {
...
// The goal of this template is to BLAH, BLAH, BLAH
	...
	/**
	 *Constructor of DataAbstractMethodDeclaration
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public DataAbstractMethodDeclaration() {
		 super(); 
	}
	 ...
	 * @generated
	 */
	//public DataAbstractMethodDeclaration(DataBodyDeclaration data)
	//{
	//	this();		
	//	
