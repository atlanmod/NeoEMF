 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.TypeParameterImpl#getBounds <em>Bounds</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public EList<TypeAccess> getBounds() {
		...
		if (getData().bounds == null){
		getData().bounds = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, JavaPackage.TYPE_PARAMETER__BOUNDS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.TYPE_PARAMETER__BOUNDS);			}
...
protected static  class DataTypeParameter extends DataType {
...
// The goal of this template is to BLAH, BLAH, BLAH
	 ...
	 * @generated
	 */
	//public DataTypeParameter(DataType data)
	//{
	//	this();		
	//	
