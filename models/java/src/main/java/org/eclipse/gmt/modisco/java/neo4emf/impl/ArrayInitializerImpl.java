 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.ArrayInitializerImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public EList<Expression> getExpressions() {
		...
		if (getData().expressions == null){
		getData().expressions = new EObjectContainmentEList<Expression>(Expression.class, this, JavaPackage.ARRAY_INITIALIZER__EXPRESSIONS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.ARRAY_INITIALIZER__EXPRESSIONS);			}
		return getData().expressions;
	} finally {
