 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.TypeImpl#getUsagesInTypeAccess <em>Usages In Type Access</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypeImpl extends NamedElementImpl implements Type {
	...
	protected DataType getData(){
		if ( data == null || !(data instanceof DataType)){
			data = new DataType();
			if (isLoaded())
...
/** genFeaure.override.javajetinc **/
	...
	public EList<TypeAccess> getUsagesInTypeAccess() {
		...
		getData().usagesInTypeAccess = new EObjectWithInverseResolvingEList<TypeAccess>(TypeAccess.class, this, JavaPackage.TYPE__USAGES_IN_TYPE_ACCESS, JavaPackage.TYPE_ACCESS__TYPE);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.TYPE__USAGES_IN_TYPE_ACCESS);			}
...
/**
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case JavaPackage.TYPE__USAGES_IN_TYPE_ACCESS:
...
protected static  class DataType extends DataNamedElement {
...
// The goal of this template is to BLAH, BLAH, BLAH
	 ...
	 * @generated
	 */
	//public DataType(DataNamedElement data)
	//{
	//	this();		
	//	
	//	name = data.name;
