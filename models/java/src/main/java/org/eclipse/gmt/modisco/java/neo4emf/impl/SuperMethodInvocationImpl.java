 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SuperMethodInvocationImpl#getMethod <em>Method</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SuperMethodInvocationImpl#getArguments <em>Arguments</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SuperMethodInvocationImpl#getTypeArguments <em>Type Arguments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public AbstractMethodDeclaration getMethod() {
		...
		if (getData().method == null && isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SUPER_METHOD_INVOCATION__METHOD);
		}		
 ...
 */
	public void setMethod(AbstractMethodDeclaration newMethod) {
	    ...
	    addChangelogEntry(newMethod, JavaPackage.SUPER_METHOD_INVOCATION__METHOD);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<Expression> getArguments() {
		...
		getData().arguments = new EObjectContainmentEList<Expression>(Expression.class, this, JavaPackage.SUPER_METHOD_INVOCATION__ARGUMENTS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SUPER_METHOD_INVOCATION__ARGUMENTS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public EList<TypeAccess> getTypeArguments() {
		...
		getData().typeArguments = new EObjectContainmentEList<TypeAccess>(TypeAccess.class, this, JavaPackage.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SUPER_METHOD_INVOCATION__TYPE_ARGUMENTS);			}
...
protected static  class DataSuperMethodInvocation extends DataAbstractTypeQualifiedExpression {
...
// The goal of this template is to BLAH, BLAH, BLAH
	 ...
	 * @generated
	 */
	//public DataSuperMethodInvocation(DataAbstractTypeQualifiedExpression data)
	//{
	//	this();		
	//	
