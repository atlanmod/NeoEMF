 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SwitchCaseImpl#isDefault <em>Default</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.SwitchCaseImpl#getExpression <em>Expression</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 ...
 */
	public void setDefault(boolean newDefault) {
		...
		boolean oldDefault = getData().default_;
		getData().default_ = newDefault;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
			this, Notification.SET,
			JavaPackage.SWITCH_CASE__DEFAULT,
			oldDefault, getData().default_));
	    addChangelogEntry(newDefault, JavaPackage.SWITCH_CASE__DEFAULT);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public Expression getExpression() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.SWITCH_CASE__EXPRESSION);
		}
 ...
 */
	public void setExpression(Expression newExpression) {
		...
		if (newExpression != getData().expression) {
			...
			if (getData().expression != null)
				msgs = ((InternalEObject) getData().expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.SWITCH_CASE__EXPRESSION, null, msgs);
	    ...
	    addChangelogEntry(newExpression, JavaPackage.SWITCH_CASE__EXPRESSION);
	} 
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case JavaPackage.SWITCH_CASE__DEFAULT:
				return isDefault() != DataSwitchCase.DEFAULT_EDEFAULT;
			case JavaPackage.SWITCH_CASE__EXPRESSION:
