 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.BodyDeclarationImpl#getAbstractTypeDeclaration <em>Abstract Type Declaration</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.BodyDeclarationImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.BodyDeclarationImpl#getAnonymousClassDeclarationOwner <em>Anonymous Class Declaration Owner</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.neo4emf.impl.BodyDeclarationImpl#getModifier <em>Modifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
/** genFeaure.override.javajetinc **/
	...
	public AbstractTypeDeclaration getAbstractTypeDeclaration() {
		...
		if (isLoaded() && eContainer() == null) {
			AbstractTypeDeclaration abstractTypeDeclaration = (AbstractTypeDeclaration) ((INeo4emfResource) this.eResource()).getContainerOnDemand(this, JavaPackage.BODY_DECLARATION__ABSTRACT_TYPE_DECLARATION);
			basicSetAbstractTypeDeclaration(abstractTypeDeclaration,null);}
 ...
 */
	public void setAbstractTypeDeclaration(AbstractTypeDeclaration newAbstractTypeDeclaration) {
		...
		if (newAbstractTypeDeclaration != eInternalContainer() || (eContainerFeatureID() != JavaPackage.BODY_DECLARATION__ABSTRACT_TYPE_DECLARATION && newAbstractTypeDeclaration != null)) {
			if (EcoreUtil.isAncestor(this, (EObject)newAbstractTypeDeclaration))
	    ...
	    addChangelogEntry(newAbstractTypeDeclaration, JavaPackage.BODY_DECLARATION__ABSTRACT_TYPE_DECLARATION);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public EList<Annotation> getAnnotations() {
		...
		getData().annotations = new EObjectContainmentEList<Annotation>(Annotation.class, this, JavaPackage.BODY_DECLARATION__ANNOTATIONS);
			if (isLoaded()) 
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.BODY_DECLARATION__ANNOTATIONS);			}
...
/** genFeaure.override.javajetinc **/
	...
	public AnonymousClassDeclaration getAnonymousClassDeclarationOwner() {
		...
		if (isLoaded() && eContainer() == null) {
			AnonymousClassDeclaration anonymousClassDeclarationOwner = (AnonymousClassDeclaration) ((INeo4emfResource) this.eResource()).getContainerOnDemand(this, JavaPackage.BODY_DECLARATION__ANONYMOUS_CLASS_DECLARATION_OWNER);
			basicSetAnonymousClassDeclarationOwner(anonymousClassDeclarationOwner,null);}
 ...
 */
	public void setAnonymousClassDeclarationOwner(AnonymousClassDeclaration newAnonymousClassDeclarationOwner) {
		...
		if (newAnonymousClassDeclarationOwner != eInternalContainer() || (eContainerFeatureID() != JavaPackage.BODY_DECLARATION__ANONYMOUS_CLASS_DECLARATION_OWNER && newAnonymousClassDeclarationOwner != null)) {
			if (EcoreUtil.isAncestor(this, (EObject)newAnonymousClassDeclarationOwner))
				throw new IllegalArgumentException("Recursive containment not allowed for " + toString());
			NotificationChain msgs = null;
			if (eInternalContainer() != null)
				msgs = eBasicRemoveFromContainer(msgs);
	    ...
	    addChangelogEntry(newAnonymousClassDeclarationOwner, JavaPackage.BODY_DECLARATION__ANONYMOUS_CLASS_DECLARATION_OWNER);
	} 
...
/** genFeaure.override.javajetinc **/
	...
	public Modifier getModifier() {
		...
		if (isLoaded()) {
			((INeo4emfResource) this.eResource()).getOnDemand(this, JavaPackage.BODY_DECLARATION__MODIFIER);
		}
	...
	public void setModifier(Modifier newModifier) {
		...
		if (newModifier != getData().modifier) {
			...
			if (getData().modifier != null)
				msgs = ((InternalEObject) getData().modifier).eInverseRemove(this, JavaPackage.MODIFIER__BODY_DECLARATION, Modifier.class, msgs);
			if (newModifier != null)
	    ...
	    addChangelogEntry(newModifier, JavaPackage.BODY_DECLARATION__MODIFIER);
	} 
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case JavaPackage.BODY_DECLARATION__MODIFIER:
				if (getData().modifier != null)
					msgs = ((InternalEObject)getData().modifier).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.BODY_DECLARATION__MODIFIER, null, msgs);
...
protected static  class DataBodyDeclaration extends DataNamedElement {
...
// The goal of this template is to BLAH, BLAH, BLAH
	 ...
	 * @generated
	 */
	//public DataBodyDeclaration(DataNamedElement data)
	//{
	//	this();		
	//	
	//	name = data.name;
