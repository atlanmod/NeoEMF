...
public class TestPackageImpl extends EPackageImpl implements TestPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getContainer_Nodes(), this.getVertex(), this.getVertex_Container(), "nodes", null, 0, -1, fr.inria.atlanmod.neo4emf.testdata.Container.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
