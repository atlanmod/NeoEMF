...
public interface MapSamplePackage extends EPackage {
	...
	EReference getPack_OwnedContents();
				...
				/**
     * Returns the meta object for the attribute '{@link fr.inria.atlanmod.neoemf.test.commons.models.mapSample.Pack#getName <em>Name</em>}'.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @return the meta object for the attribute '<em>Name</em>'.
     * @see fr.inria.atlanmod.neoemf.test.commons.models.mapSample.Pack#getName()
     * @see #getPack()
     * @generated
     */
