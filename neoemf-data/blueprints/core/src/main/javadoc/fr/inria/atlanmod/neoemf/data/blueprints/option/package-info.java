 ...
 * fr.inria.atlanmod.neoemf.data.blueprints.option.BlueprintsOptions}: a fluent API allowing to easily set Blueprints
 ...
 * it can be used to combine Blueprints specific and generic options.</li> </ul>
 * <p>
 * Options defined using the classes inside this package are usable for each Blueprints implementation. For
