 ...
 * fr.inria.atlanmod.neoemf.option.PersistenceOptionsBuilder}: <ul> <li>{@link fr.inria.atlanmod.neoemf.data.blueprints.option.BlueprintsResourceOptions}:
 ...
 * fr.inria.atlanmod.neoemf.data.blueprints.option.BlueprintsOptionsBuilder}: a fluent API allowing to easily set
 * Blueprints specific options in client applications. Since the builder implements {@link
 * fr.inria.atlanmod.neoemf.option.PersistenceOptionsBuilder} it can be used to combine Blueprints specific and generic
 * options.</li> </ul>
 * <p>
