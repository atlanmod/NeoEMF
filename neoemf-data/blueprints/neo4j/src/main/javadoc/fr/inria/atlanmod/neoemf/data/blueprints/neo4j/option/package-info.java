 ...
 * <p>
 * Options defined using the classes inside this package are only usable with Neo4j as the concrete
 ...
 * and {@link fr.inria.atlanmod.neoemf.data.blueprints.option.BlueprintsOptionsBuilder}: <ul> <li>{@link
 ...
 * fr.inria.atlanmod.neoemf.data.blueprints.option.BlueprintsOptionsBuilder} it can be used to combine Neo4j,
 ...
 * fr.inria.atlanmod.neoemf.data.blueprints.neo4j.option.BlueprintsNeo4jOptionsBuilder} to create the option map
