...
/**
 * An abstract {@link RedisBackend} that provides overall behavior for the management of a Redis
 * database.
 */
@ParametersAreNonnullByDefault
abstract class AbstractRedisBackend extends AbstractBackend implements RedisBackend {

    /**
     * Constructs a new {@code AbstractRedisBackend}.
     */
    protected AbstractRedisBackend() {
