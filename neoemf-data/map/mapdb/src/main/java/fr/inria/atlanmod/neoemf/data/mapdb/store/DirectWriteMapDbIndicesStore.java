...
public class DirectWriteMapDbIndicesStore extends DirectWriteMapDbStore {
    ...
    /**
     * Creates a new {@link DirectWriteMapDbIndicesStore} for the given {@link Resource} and {@link MapDbPersistenceBackend}.
