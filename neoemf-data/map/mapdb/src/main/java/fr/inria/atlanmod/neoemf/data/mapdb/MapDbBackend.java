 ...
 * MapDB database.
 */
public abstract class MapDbBackend extends AbstractPersistenceBackend implements MapBackend {
    ...
    /**
     * Constructs a new {@code MapDbBackend} wrapping the provided {@code db}.
     * <p>
