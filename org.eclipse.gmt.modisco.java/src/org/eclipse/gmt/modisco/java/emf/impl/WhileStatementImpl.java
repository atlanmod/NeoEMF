 ...
 * <ul>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.WhileStatementImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.eclipse.gmt.modisco.java.emf.impl.WhileStatementImpl#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhileStatementImpl extends StatementImpl implements WhileStatement {
	...
	public void setBody(Statement newBody) {
		if (newBody != body) {
			NotificationChain msgs = null;
			if (body != null)
				msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JavaPackage.WHILE_STATEMENT__BODY, null, msgs);
			if (newBody != null)
