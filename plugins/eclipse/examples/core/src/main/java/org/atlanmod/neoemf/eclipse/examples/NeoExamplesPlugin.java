...
public class NeoExamplesPlugin extends AbstractUIPlugin {
     ...
     */
    public static final String PLUGIN_ID = "org.atlanmod.neoemf.eclipse.examples";

    public static final String BUNDLE_ID = "org.atlanmod.neoemf.eclipse.examples.core";
