 ...
 * <p>
 * This package define a set of abstraction that can be used by {@link fr.inria.atlanmod.neoemf.data.store.PersistentStore}
 * subclasses as an intermediate layer between the backend level and the model level. For example, the {@link
 * fr.inria.atlanmod.neoemf.data.structure.ContainerInfo} class can be used to represent a containment link between two
